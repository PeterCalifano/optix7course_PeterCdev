...
namespace osc
{
  ...
  void SampleRenderer::createTextures()
  {
    ...
    for (int textureID = 0; textureID < numTextures; textureID++)
    {
      ...
      if (cuda_tex != 0)
      {
        printf("DEBUG: Texture object created successfully by CreateTextureObject()\n");
      }
  ...
  OptixTraversableHandle SampleRenderer::buildAccel()
  {
    ...
    for (int meshID = 0; meshID < numMeshes; meshID++)
    {
      ...
      if (!mesh.normal.empty())
        printf("Assigning normal to normalBuffer[%d]\n", meshID);
        normalBuffer[meshID].alloc_and_upload(mesh.normal);
      if (!mesh.texcoord.empty())
        printf("Assigning texcoord to texcoordBuffer[%d]\n", meshID);
  ...
  void SampleRenderer::buildSBT()
  {
    ...
    for (int meshID = 0; meshID < numObjects; meshID++)
    {
      ...
      if (mesh->diffuseTextureID >= 0)
      {
        ...
        printf("DEBUG: Mesh %d has texture ID %d\n", meshID, mesh->diffuseTextureID);
